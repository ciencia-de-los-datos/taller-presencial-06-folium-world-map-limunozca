...
def add_countries_column(affiliations):
    ...
    #pegueme la lista de paises colonado entre ellos , con espacio en blanco 
...
# affiliations = clean_countries(affiliations)
# countries = count_country_frequency(affiliations)
# countries = plot_world_map(countries)
# print(countries.head())




#me interesa para cada papaer lista de paises sin repetir
# print(load_affiliations().head(1).values)
#tiene dpto, universidad, ubicación, país separado por ,
...
#es una cadena de texto donde las ubicaciones están separadas po ;  y de cada ubicacion los elementos estan
#separados por , y el país siempre aparece de último
#me interesa saber los paises que tienen las ubicaciones
